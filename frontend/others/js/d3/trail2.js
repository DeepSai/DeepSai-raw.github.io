...
function trail1() {
    ...
    svg.append("g")
        ...
        .call(d3.axisBottom(x2).ticks(null, '%'))
        .append("text")
    ...
    //     .data(bins)
    //     .enter().append("rect")
    //     .attr("y", function (d) { return x(d.x0) + 1; })
    //     .attr("x", function (d) { return y(d.length / n); })
    //     // .attr("width", function (d) { return x(d.x1) - x(d.x0) - 1; })
    //     // .attr("height", function (d) { return y(0) - y(d.length / n); });
    //     .attr("height", function (d) { return x(d.x1) - x(d.x0) - 1; })
    //     .attr("width", function (d) { return y(0) - y(d.length / n); });
    ...
    svg.append("path")
        ...
        .attr("d", d3.line()
            .curve(d3.curveBasis)
            .y(function (d) { return width - x(d[0]); })
            .x(function (d) { return height - y(d[1]); }));
    // });
